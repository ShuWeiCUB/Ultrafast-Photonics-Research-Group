    ...
    def fit(self, t, FROG0, FROG1, qvalue, grad, grad_flat, counter, weights, loss_value, barrier, lock):
       ...
       '''
        ...
        def loss_and_flat_grad(w, epoch, grad, grad_flat, counter,weights, loss_value, barrier, lock):
            ...
            #print("datatype of weights " + str(type(weights)))
            
            #print("shape of counter " + str(counter.shape))
            #print("datatype of counter " + str(type(counter)))
            
            #print("shape of grad " + str(grad.shape))
            #print("datatype of grad " + str(type(grad)))
            #print("datatype of grad_flat " + str(type(grad_flat)))
            #print("datatype of loss_value " + str(type(loss_value)))
            ...
            for cord in np.atleast_1d(qvalue):
                ...
                #8print("computing loss uses makefrog " + str(timeloss23))
                #8print("computing loss uses " + str(timeloss))


                #8print("summation of gradients " + str(timeloss34))
...
def get_PINN(hp = hp, datafname = 'PI_FROG_SIM_v1.mat',indexnum = 'last',ModelDirectory = os.getcwd(),D_trainable = False, N2_trainable = False, Load_Trained_model = False):
    ...
    print("D_Truth " + str(sim_hpBM['D']/2))
    print("N2_Truth " + str(sim_hpBM['N2']))
