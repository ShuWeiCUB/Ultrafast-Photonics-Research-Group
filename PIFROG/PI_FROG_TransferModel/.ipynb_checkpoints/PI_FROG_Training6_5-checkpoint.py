...
def run_model(model_id, grad, grad_flat, counter, weights, loss_value, all_h0r, all_h0i, all_h1r, all_h1i,  phase_loss_shared, frog_loss_shared, bound_loss_shared, barrier, lock):
    ...
    #pinn.load_latest_checkpoint(indexnum=123456)
    barrier.wait()
    pinn.Start_fit(qvalue, grad, grad_flat, counter, weights, loss_value, all_h0r, all_h0i, all_h1r, all_h1i, phase_loss_shared, frog_loss_shared, bound_loss_shared, barrier,lock, loadbasemodel=True) 
    ...
    if np.any(qvalue == 99):
        ...
        myplots.myimshow(z, t, Intensity.T, cbar=True)
...
if __name__ == "__main__":
    ...
    with mp.Manager() as manager:
        ...
        for i in range(num_workers):
            p = mp.Process(target=run_model, args= (qvalue[i, :], grad, grad_flat, counter, weights, loss_value, all_h0r, all_h0i, all_h1r, all_h1i, phase_loss_shared, frog_loss_shared, bound_loss_shared, barrier, lock)) 
