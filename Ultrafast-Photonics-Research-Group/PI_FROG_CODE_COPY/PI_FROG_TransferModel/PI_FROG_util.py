...
def prep_data(datafname,hp, FROGtype = 'SHG', GlobalPath = os.getcwd(), RKsteps = 1, N_u=None, N_f=None, N_n=None, q=100, ub=None, lb=None, SNR=np.inf, AmpNoise = True, N = 2**9):
